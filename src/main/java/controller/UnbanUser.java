...
public class UnbanUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Initialise une variable pour stocker l'identifiant de l'utilisateur à réactiver
        Integer id = null;
        ...
        try {
            // Récupère l'identifiant de l'utilisateur à réactiver depuis les paramètres de la requête
            ...
            daop.unbanUser(id, true);
        } catch (NumberFormatException ex) {
            // Gère une exception si la conversion de l'identifiant échoue
            throw new RuntimeException("Réactivation utilisateur impossible");
        }

        // Redirige vers la page d'administration après la réactivation
