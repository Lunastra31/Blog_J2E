 ...
 * @author stag
 */
@WebServlet(urlPatterns = "/Positive")
public class Positive extends HttpServlet {

// <editor-fold defaultstate="collapsed" desc="The following has evaluated to null or missing:
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int votesPositifs = daov.countPositive(id_news);
        request.getSession().setAttribute("votesPositifs", votesPositifs);
